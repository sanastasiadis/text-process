package org.stavros.text.process.examples.jsp2;
...
import org.stavros.text.process.module.spec.AbstractFileExtensionDirectoryChecker;

public class FileChecker extends AbstractFileXmlProcessor implements FileProcessor {
